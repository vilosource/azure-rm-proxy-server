...
def build_graph(vm_data: Dict[str, Any], gateway_ip: str, gateway_routes: List[Dict[str, str]]) -> nx.DiGraph:
    """
            ...
            if route['next_hop_type'] == 'VnetLocal':
                ...
                for other_vm, other_vm_data in vm_data.items():
                    if vm_name != other_vm and 'network_interfaces' in other_vm_data:
                        other_ips = other_vm_data['network_interfaces'][0].get('private_ip_addresses', [])
...
def main():
    ...
    parser.add_argument('-g', '--gateway-ip', default="20.240.246.240", help="Virtual Network Gateway IP")
