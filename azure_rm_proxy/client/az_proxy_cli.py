...
def display_resource_groups(resource_groups: List[Dict[str, Any]], output_format: str) -> None:
    ...
    if output_format == "json":
        ...
        for rg in resource_groups:
            ...
            tags_str = json.dumps(rg.get("tags", {}), separators=(',', ':')) if rg.get("tags") else ""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Azure RM Proxy CLI - Command-line client for the Azure RM Proxy Server")
    parser.add_argument("--base-url", default=DEFAULT_BASE_URL, help=f"Base URL of the Azure RM Proxy Server (default: {DEFAULT_BASE_URL})")
    ...
    rg_parser = subparsers.add_parser("list-resource-groups", help="List resource groups in a subscription")
    ...
    vm_parser.add_argument("--resource-group", required=True, help="Resource group name")
    
    # Get VM details
    vm_details_parser = subparsers.add_parser("get-vm-details", help="Get detailed information about a specific virtual machine")
    vm_details_parser.add_argument("--subscription-id", required=True, help="Subscription ID")
    vm_details_parser.add_argument("--resource-group", required=True, help="Resource group name")
    vm_details_parser.add_argument("--vm-name", required=True, help="Virtual machine name")
