    ...
    async def get_subscriptions(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            self.save_json_fixture(
                subscriptions, 
                f"subscriptions_{self.timestamp}.json"
            )
    ...
    async def get_virtual_machines(
        ...
        try:
            ...
            if vms:
                self.save_json_fixture(
                    vms, 
                    f"vms_{subscription_id}_{resource_group}_{self.timestamp}.json"
                )
...
async def main():
    ...
    parser.add_argument('--output-dir', type=str, default='./test_harnesses',
    ...
    parser.add_argument('--vm-name', type=str, default=None,
                        help='Target specific virtual machine')
    parser.add_argument('--max-concurrency', type=int, default=5,
                        help='Maximum number of concurrent Azure API calls (default: 5)')
    parser.add_argument('--skip-vm-details', action='store_true',
