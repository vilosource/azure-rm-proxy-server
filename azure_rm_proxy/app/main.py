...
from ..api import subscriptions, resource_groups, virtual_machines, vm_shortcuts, vm_hostnames
...
class RequestLoggingMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        request_logger.info(f"Request {request_id} completed: {method} {url} - Status: {status_code} - Time: {formatted_process_time}s")
