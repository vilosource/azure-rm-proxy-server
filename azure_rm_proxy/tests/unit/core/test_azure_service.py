...
class TestAzureResourceService:
    ...
    async def test_get_virtual_machines(self, service, mock_cache):
        ...
        type(mock_vm1).hardware_profile = PropertyMock(return_value=MagicMock(vm_size="Standard_DS2_v2"))
        type(mock_vm1).storage_profile = PropertyMock(return_value=MagicMock(os_disk=MagicMock(os_type="Linux")))
        ...
        type(mock_vm2).hardware_profile = PropertyMock(return_value=MagicMock(vm_size="Standard_F2s_v2"))
        type(mock_vm2).storage_profile = PropertyMock(return_value=MagicMock(os_disk=MagicMock(os_type="Windows")))
        ...
        try:
            ...
            assert result[0].id == f"/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Compute/virtualMachines/vm-1"
            ...
            assert result[1].id == f"/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Compute/virtualMachines/vm-2"
