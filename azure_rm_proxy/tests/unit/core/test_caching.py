...
class TestCaching:
    ...
    @patch('azure_rm_proxy.core.caching.redis_cache.RedisCache', new=MagicMock(spec=CacheStrategy))
    ...
    def test_create_redis_cache(self, mock_import):
        ...
        sys.modules['azure_rm_proxy.core.caching.redis_cache'].RedisCache.return_value = mock_redis_cache
    ...
    def test_create_redis_cache_fallback(self, original_create_cache):
        ...
        def side_effect(cache_type, **kwargs):
            if cache_type == CacheType.REDIS:
                ...
                with patch('azure_rm_proxy.core.caching.memory_cache.MemoryCache', return_value=memory_mock):
