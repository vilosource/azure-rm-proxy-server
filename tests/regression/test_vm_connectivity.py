...
from azure_rm_network_tool.vm_connectivity import (
    parse_vm_data, build_graph, check_connectivity
)
...
class TestVMConnectivity(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.vm3_data = {
            ...
            "network_interfaces": [
                {
                    "private_ip_addresses": ["172.20.5.10"]
                }
            ],
            "effective_routes": [
                {
